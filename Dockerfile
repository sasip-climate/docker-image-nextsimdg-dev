...
RUN sudo apt-get install vim git build-essential bash-completion wget nfs-common netcdf-bin libnetcdf-c++4-dev libboost-all-dev libeigen3-dev cmake --assume-yes
